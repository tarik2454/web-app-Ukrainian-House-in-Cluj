const newsData = [
  ...
  },
  {
    ...
    description:
      'TechCorp презентувала свій новий флагманський смартфон з революційними функціями та дизайном. TechCorp презентувала свій новий флагманський смартфон з революційними функціями та дизайном. TechCorp презентувала свій новий флагманський смартфон з революційними функціями та дизайном. TechCorp презентувала свій новий флагманський смартфон з революційними функціями та дизайном.',
    date: '03.01.2024',
  },
  {
  ...
  },
  {
    ...
    description:
      'На щорічній технологічній виставці представили нові розробки в галузі штучного інтелекту та робототехніки. На щорічній технологічній виставці представили нові розробки в галузі штучного інтелекту та робототехніки. На щорічній технологічній виставці представили нові розробки в галузі штучного інтелекту та робототехніки. На щорічній технологічній виставці представили нові розробки в галузі штучного інтелекту та робототехніки.',
    date: '06.01.2024',
  },
  {
