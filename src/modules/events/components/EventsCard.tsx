            ...
            {Array.isArray(tags) && tags.length > 0 ? (
              tags.map((tag, index) => {
                ...
                return (
                  <li
                    key={index}
                    className={`rounded-md px-[10px] py-[2px] font-inter-500 text-sm font-medium ${textClass} ${bgClass}`}
                  >
                    {tag}
                  </li>
                );
              ...
              <li className="rounded-md bg-gray-500 px-[10px] py-[2px] font-inter-500 text-sm font-medium text-white">
                No tags available
              </li>
            )}
          </ul>
