...
export default function EventsTagsFilter({
  ...
  return (
    <div className="sticky top-[111px] mb-10 flex items-center justify-between gap-4 bg-white dark:bg-dark-background">
      <p className="font-inter-600 text-lg font-semibold text-black-200 dark:text-dark-title">
        Сортувати:
      </p>
          ...
          return (
            <li key={tag}>
              <button
                ...
                className={`rounded-md px-[15px] py-[7px] font-inter-500 text-sm font-medium ${textClass} ${bgClass}`}
              >
                {tag}
              </button>
            </li>
