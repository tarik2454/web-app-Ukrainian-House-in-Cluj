const eventsData = [
  {
    ...
    description:
      'Запрошуємо всіх на фестиваль сучасного мистецтва, де ви зможете побачити роботи найкращих художників країни. Запрошуємо всіх на фестиваль сучасного мистецтва, де ви зможете побачити роботи найкращих художників країни.',
    tags: ['мистецтво'],
    date: '01.02.2024',
  },
  {
    ...
    description:
      'Концерт відомих музикантів просто неба. Приходьте насолоджуватися музикою і свіжим повітрям! Концерт відомих музикантів просто неба. Приходьте насолоджуватися музикою і свіжим повітрям!',
    tags: ['майстер-клас'],
    date: '02.02.2024',
  },
  {
    ...
    description:
      'Приєднуйтесь до нашого велопробігу містом! Проведіть активний день у компанії однодумців. Приєднуйтесь до нашого велопробігу містом! Проведіть активний день у компанії однодумців.',
    tags: ['малювання'],
    date: '03.02.2024',
  },
  {
